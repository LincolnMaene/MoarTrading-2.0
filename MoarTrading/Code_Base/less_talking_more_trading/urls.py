...
from less_talking_more_trading.views import (options_data_view, order_trigger_order_view, sale_trigger_sale_view, Market_Query_view,
    Market_hours_view, Movers_Query_view, Movers_data_view, Club_chart_view, price_history_view, Price_history_query_view, Quote_query_view
    ,Quote_view, Watchlist_query_view)
